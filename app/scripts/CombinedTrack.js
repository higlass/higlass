...
class CombinedTrack {
  constructor({
    ...
    for (
      ...
      if (
        ...
        console.error(
          'Empty child track in CombinedTrack:',
          this
        );
      }
    }
    ...
    newContents.forEach(
      nc => {
        ...
        if (
          ...
          const newTrack = trackCreator(
            nc
          );
          newTrack.setPosition(
            this
              .position
          );
          newTrack.setDimensions(
            this
              .dimensions
          );
          newTracks.push(
  ...
  exportSVG() {
    ...
    for (const childTrack of this
      .childTracks) {
      if (
        childTrack.exportSVG
      ) {
