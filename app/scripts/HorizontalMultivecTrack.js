...
export default class HorizontalMultivecTrack extends HeatmapTiledPixiTrack {
  ...
  getMouseOverHtml(
    ...
    const tilePos = this.getTilePosAtPosition(
      trackX,
      trackY
    );

    let output = `Data value: ${this.getVisibleData(
      trackX,
      trackY
    )}</br>`;
    output += `Zoom level: ${
