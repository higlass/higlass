...
const _appliedMixin =
  '__mixwith_appliedMixin';
// used by wrap() and unwrap()
const _wrappedMixin =
  '__mixwith_wrappedMixin';
...
export const Cached = mixin =>
  wrap(
    ...
    superclass => {
      ...
      let application = cachedApplications.get(
        mixin
      );
      if (
        !application
