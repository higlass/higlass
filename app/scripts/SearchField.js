...
class SearchField {
  constructor(
    ...
    this.chromInfoBisector = bisector(
      d =>
        d.pos
    ).left;
  }

  scalesToPositionText(
    xScale,
    yScale,
    twoD = false
  ) {
  ...
  searchPosition(
    ...
    if (
      ...
      range1 = this.getSearchRange(
        parts[0].split(
          ' '
        )[0]
      );
      range2 = this.getSearchRange(
        parts[1].split(
          ' '
        )[0]
      );
