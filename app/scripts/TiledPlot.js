...
class TiledPlot extends React.Component {
  constructor(
    ...
    */
    ...
    this.handleNoTrackAddedBound = this.handleNoTrackAdded.bind(
      this
    );
    this.handleTracksAddedBound = this.handleTracksAdded.bind(
      this
    );
    this.closeMenusBound = this.closeMenus.bind(
      this
    );
    this.handleAddDivisorBound = this.handleAddDivisor.bind(
      this
    );
    this.handleAddSeriesBound = this.handleAddSeries.bind(
      this
    );
    this.handleChangeTrackDataBound = this.handleChangeTrackData.bind(
      this
    );
    this.handleChangeTrackTypeBound = this.handleChangeTrackType.bind(
      this
    );
    this.handleCloseTrackBound = this.handleCloseTrack.bind(
      this
    );
    this.handleConfigureTrackBound = this.handleConfigureTrack.bind(
      this
    );
    this.handleExportTrackDataBound = this.handleExportTrackData.bind(
      this
    );
    this.handleLockValueScaleBound = this.handleLockValueScale.bind(
      this
    );
    this.handleReplaceTrackBound = this.handleReplaceTrack.bind(
      this
    );
    this.handleTrackOptionsChangedBound = this.handleTrackOptionsChanged.bind(
      this
    );
    this.handleUnlockValueScaleBound = this.handleUnlockValueScale.bind(
      this
    );
    this.onAddTrack = this.handleAddTrack.bind(
      this
    );
  }
  ...
  componentDidMount() {
    ...
    this.canvasElement = ReactDOM.findDOMNode(
      this
        .props
        .canvasElement
    );
  ...
  shouldComponentUpdate(
    ...
    const thisPropsStr = this
      .previousPropsStr;
    const nextPropsStr = this.updatablePropsToString(
      nextProps
    );

    const thisStateStr = JSON.stringify(
      this
        .state
    );
    const nextStateStr = JSON.stringify(
      nextState
    );
    ...
    if (
      ...
      if (
        this
          .state
          .defaultChromSizes &&
        this.state.rangeSelection.every(
          range =>
            range &&
            range.length
        )
        ...
        genomicRange = this.state.rangeSelection.map(
          range =>
            dataToGenomicLoci(
              ...range,
              this
    ...
    if (
      ...
      this.props.modal.open(
        <AddTrackDialog
          ...
          onCancel={
            this
              .handleNoTrackAddedBound
          }
          onTracksChosen={
            this
              .handleTracksAddedBound
          }
          position={
            this
              .state
  ...
  */
  ...
  contextMenuHandler(
    ...
    const canvasMousePos = clientPoint(
      this
        .divTiledPlot,
      e
    );
    ...
    // rule
    const xVal = this.trackRenderer.zoomedXScale.invert(
      canvasMousePos[0]
    );
    const yVal = this.trackRenderer.zoomedYScale.invert(
      canvasMousePos[1]
    );
    ...
    if (
      ...
      contextMenuCustomItems = e.hgCustomItems.map(
        item => (
          <ContextMenuItem
            key={
              item.key
  ...
  handleTrackOptionsChanged(
     ...
     */
    return this.props.onTrackOptionsChanged(
      trackUid,
      newOptions
    );
  }
  ...
  handleTilesetInfoReceived(
    ...
    track.transforms =
      tilesetInfo.transforms;
    track.aggregationModes =
      tilesetInfo.aggregation_modes;
    track.header =
      tilesetInfo.header;
    track.binsPerDimension =
    ...
    track.coordSystem =
      tilesetInfo.coordSystem;
    track.datatype =
      tilesetInfo.datatype;
  }
  ...
  checkAllTilesetInfoReceived() {
    ...
    const trackUids = allTracksWithTilesetInfos.reduce(
      (
        a,
        b
      ) => {
    ...
    const loadedTilesetInfos = Object.keys(
      this
        .tracksByUidInit
    ).filter(
      trackUid =>
    ...
    if (
      allTracksWithTilesetInfos.length ===
      loadedTilesetInfos
    ) {
      this.setState(
        {
  ...
  handleAddSeries(
    ...
    const trackPosition = getTrackPositionByUid(
      this
        .props
        .tracks,
      trackUid
  ...
  handleResizeTrack(
    ...
    for (const trackType in tracks) {
      ...
      const filteredTracks = theseTracks.filter(
        d =>
          d.uid ===
          uid
      );
  ...
  calculateTrackPosition(
    ...
    if (
      TRACK_LOCATIONS.indexOf(
        location
      ) ===
      -1
    ) {
      console.warn(
        'Track with unknown position present:',
        location,
        track
      );
    }
  ...
  findCentralHeatmapTrack(
    ...
    for (
      ...
      if (
        ...
        return this.findCentralHeatmapTrack(
          tracks[
            i
          ]
            .contents
      ...
      const overlayDefs = this.props.overlays
        ...
        .map(
          overlayTrack => {
            ...
            const overlayDef = Object.assign(
              {},
              overlayTrack,
              {
                uid:
  ...
  createTrackPositionTexts() {
    ...
    const trackElements = positionedTracks.map(
      trackPosition => {
        const {
          track
        } = trackPosition;
  ...
  handleZoomToData() {
          ...
          for (
            ...
            if (
              ...
              minPos[
                ...
                trackObject.tilesetInfo.min_pos[
                  j
                ];
            }
            ...
            if (
              ...
              maxPos[
                ...
                trackObject.tilesetInfo.max_pos[
                  j
                ];
            }
          }
    ...
    let newXDomain = [
      ...
      this.trackRenderer.zoomTransform.rescaleX(
        this
          .trackRenderer
          .xScale
      )
    ...
    let newYDomain = [
      ...
      this.trackRenderer.zoomTransform.rescaleY(
        this
          .trackRenderer
          .yScale
      )
    ...
    return JSON.stringify(
      {
        ...
        initialYDomain:
          props.initialYDomain,
        trackSourceServers:
          props.trackSourceServers,
        zoomable:
          props.zoomable,
        draggingHappending:
          props.draggingHappening
      }
    );
  }
    ...
    return range => {
      this.setState(
        prevState => {
          ...
          let dataPos = this.rangeViewToDataLoci(
            range,
            scale
          );
  ...
  rangeSelection2dEndHandler(
    ...
    const dataPosX = this.rangeViewToDataLoci(
      range[0],
      this
        .xScale
    );
    const dataPosY = this.rangeViewToDataLoci(
      range[1],
      this
        .yScale
    );
      ...
      return (
        ...
        >
          <ViewContextMenu
            ...
            onAddDivisor={
              this
                .handleAddDivisorBound
            }
            onAddSeries={
              this
                .handleAddSeriesBound
            }
            ...
            onChangeTrackData={
              this
                .handleChangeTrackDataBound
            }
            onChangeTrackType={
              this
                .handleChangeTrackTypeBound
            }
            onCloseTrack={
              this
                .handleCloseTrackBound
            }
            onConfigureTrack={
              this
                .handleConfigureTrackBound
            }
            onExportData={
              this
                .handleExportTrackDataBound
            }
            onLockValueScale={
              this
                .handleLockValueScaleBound
            }
            onReplaceTrack={
              this
                .handleReplaceTrackBound
            }
            onTrackOptionsChanged={
              this
                .handleTrackOptionsChangedBound
            }
            onUnlockValueScale={
              this
                .handleUnlockValueScaleBound
            }
            orientation="right"
            position={
              this
  ...
  getIdealizedTrackPositionsOverlay() {
    ...
    const topRightDiv = React.cloneElement(
      topLeftDiv
    );
    ...
    const rightDiv = React.cloneElement(
      leftDiv,
      {
        defaultTrackType:
          defaultTracks.right,
  ...
  render() {
    ...
    const topTracks = (
      ...
      >
        <HorizontalTiledPlot
          ...
          handleConfigTrack={this.handleConfigTrackMenuOpened.bind(
            this
          )}
          handleResizeTrack={this.handleResizeTrack.bind(
            this
          )}
          handleSortEnd={this.handleSortEnd.bind(
            this
          )}
          is1dRangeSelection={
            this
          ...
          onAddSeries={this.handleAddSeries.bind(
            this
          )}
          onCloseTrack={this.handleCloseTrack.bind(
            this
          )}
          onCloseTrackMenuOpened={this.handleCloseTrackMenuOpened.bind(
            this
          )}
          onConfigTrackMenuOpened={this.handleConfigTrackMenuOpened.bind(
            this
          )}
          onRangeSelection={this.rangeSelection1dHandler(
            'x'
          ).bind(
            this
          )}
          onRangeSelectionEnd={this.rangeSelection1dEndHandler(
            'x'
          ).bind(
            this
          )}
          onRangeSelectionReset={this.rangeSelectionResetHandler.bind(
            this
          )}
          onRangeSelectionStart={this.rangeSelection1dStartHandler.bind(
            this
          )}
          rangeSelection={
            this
      ...
      centerTrack = (
        ...
        >
          <CenterTrack
            ...
            onRangeSelectionStart={this.rangeSelection2dStartHandler.bind(
              this
            )}
            onRangeSelectionX={this.rangeSelection1dHandler(
              'x'
            ).bind(
              this
            )}
            onRangeSelectionXEnd={this.rangeSelection1dEndHandler(
              'x'
            ).bind(
              this
            )}
            onRangeSelectionXY={this.rangeSelection2dHandler.bind(
              this
            )}
            onRangeSelectionXYEnd={this.rangeSelection2dEndHandler.bind(
              this
            )}
            onRangeSelectionY={this.rangeSelection1dHandler(
              'y'
            ).bind(
              this
            )}
            onRangeSelectionYEnd={this.rangeSelection1dEndHandler(
              'y'
            ).bind(
              this
            )}
    ...
    if (
      ...
      trackRenderer = (
        <TrackRenderer
          ...
          onScalesChanged={this.handleScalesChanged.bind(
            this
          )}
          onTilesetInfoReceived={this.handleTilesetInfoReceived.bind(
            this
          )}
          onTrackOptionsChanged={this.handleTrackOptionsChanged.bind(
            this
          )}
          onValueScaleChanged={
            this
    ...
    if (
      ...
      closeTrackMenu = (
        <PopupMenu
          onMenuClosed={this.handleCloseTrackMenuClosed.bind(
            this
          )}
        >
