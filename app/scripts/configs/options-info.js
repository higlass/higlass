...
const AVAILABLE_WIDTHS = sizesInPx(
  [
    1,
    2,
    3,
...
const AVAILABLE_MARGIN = sizesInPx(
  [
    0,
    2,
    4,
...
const OPACITY_OPTIONS = sizesInPx(
  [
    0.0,
    0.2,
    0.4,
...
const OPACITY_OPTIONS_NO_ZERO = sizesInPx(
  [
    0.2,
    0.4,
    0.6,
