...
class PlotTypeChooser extends React.Component {
  constructor(
    ...
    this.state = {
      selectedPlotType: this
        .AVAILABLE_TRACK_TYPES[0]
    };
  }
  ...
  UNSAFE_componentWillReceiveProps(
    ...
    if (
      ...
      if (
        !this.AVAILABLE_TRACK_TYPES.includes(
          this
            .state
            .selectedPlotType
        )
  ...
  handlePlotTypeSelected(
    ...
    this.props.onPlotTypeSelected(
      key.type
    );
  }

  render() {
    let AVAILABLE_TRACK_TYPES_LIST =
      'No plot types available for track';
    ...
    return (
      <div>
        {AVAILABLE_TRACK_TYPES_LIST.length >
          0 && (
