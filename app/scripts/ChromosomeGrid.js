...
class ChromosomeGrid extends PixiTrack {
  constructor(
    ...
    ChromosomeInfo(
      ...
      newChromInfo => {
        ...
        this.lineGraphics.addChild(
          this
            .lineGraphics1dH
        );
        this.lineGraphics1dH.addChild(
          this
            .mask1dH
        );
        this.lineGraphics.addChild(
  ...
  draw() {
    ...
    if (
      ...
      this.mask1dV.clear();
      this.mask2d.clear();
      this.mask1dH.beginFill(
        0xffffff
      );
      this.mask1dV.beginFill(
        0xffffff
      );
      this.mask2d.beginFill(
        0xff0000
      );
      ...
      for (
        ...
        const {
          ...
          width,
          height
        } = this.options.orientationsAndPositions[
          i
        ].position;
