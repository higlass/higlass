      ...
      promise.then(
        returnedTiles => {
          ...
          for (
            ...
            const fullTileId = this.fullTileId(
              tilesetUid,
              tileIds[
                i
              ]
      ...
      Promise.all(
        ...
        returnedTiles => {
          ...
          if (
            ...
            const newTiles = this.makeDivided(
              returnedTiles,
              tileIds
            );
