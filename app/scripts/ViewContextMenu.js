...
class ViewContextMenu extends mix(
    ...
    return (
      ...
      >
        ...
        {this.hasMatrixTrack(
          ...
          <ContextMenuItem
            onClick={this.handleAddHorizontalSection.bind(
              this
            )}
            onMouseEnter={e =>
              this.handleOtherMouseEnter(
        ...
        {this.hasMatrixTrack(
          ...
          <ContextMenuItem
            onClick={this.handleAddVerticalSection.bind(
              this
            )}
            onMouseEnter={e =>
              this.handleOtherMouseEnter(
  ...
  hasMatrixTrack(
    ...
    const trackList = expandCombinedTracks(
      this
        .props
        .tracks
    );
