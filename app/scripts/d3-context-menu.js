...
function contextMenu(
  ...
  let orientation =
    'right'; // display the menu to the right of the mouse click
  // or parent elemement
  let initialPos = null;
  ...
  return function onContextMenu(
        ...
        function mouseEnter(
          ...
          if (
            ...
            if (
              ...
              select(
                `.d3-context-menu-${openChildMenuUid}`
              ).style(
                'display',
                'none'
              );
          ...
          if (
            ...
            if (
              ...
              childrenContextMenu = contextMenu(
                d.children,
                {
            ...
            d.childUid = childrenContextMenu.apply(
              this,
              [
                data,
                i,
    ...
    const contextMenuSelection = select(
      `.d3-context-menu-${uid}`
    ).style(
      'display',
      'block'
    ...
    const boundingRect = contextMenuSelection
      .node()
