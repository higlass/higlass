...
class ViewConfigEditor extends React.Component {
  constructor(
    ...
    this.handleChangeBound = this.handleChange.bind(
      this
    );
    this.handleKeyDownBound = this.handleKeyDown.bind(
      this
    );
    this.handleKeyUpBound = this.handleKeyUp.bind(
      this
    );
    this.handleSubmitBound = this.handleSubmit.bind(
      this
    );
    this.hideBound = this.hide.bind(
      this
    );
    this.showBound = this.show.bind(
      this
    );
  ...
  async componentDidMount() {
    if (
      ...
      this.editor._input.setSelectionRange(
        0,
        0
      );
      await timeout(
