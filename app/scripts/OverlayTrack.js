...
class OverlayTrack extends PixiTrack {
  ...
  draw() {
    ...
    if (
      ...
      this.options.orientationsAndPositions.forEach(
        op => {
          if (
            op.orientation ===
              '1d-horizontal' ||
  ...
  exportSVG() {
    // TODO: implement me
    console.warn(
      'Overlay tracks cannot be exported as SVG yet.'
    );
  }
}
