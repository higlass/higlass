...
function addNode(
  ...
  let child = new IntervalTreeNode(
    interval[0],
    interval[1]
  );
  child.max =
 ...
 */
IntervalTree.prototype.add = function add(
  interval
) {
  if (
    !this
 ...
 */
IntervalTree.prototype.contains = function _contains(
  point
) {
  return contains(
    point,
 ...
 */
IntervalTree.prototype.intersects = function _intersects(
  interval
) {
  return intersectsHelper(
    interval,
    this
      .root
  );
 ...
 */
IntervalTree.prototype.findMax = function findMax(
  node
) {
  const stack = [
    node
...
IntervalTree.prototype._removeHelper = function _removeHelper(
  interval,
  node
) {
  if (
 ...
 */
IntervalTree.prototype.remove = function remove(
  interval
) {
  return this._removeHelper(
    interval,
    this
      .root
  );
