...
class GBKDataFetcher {
  constructor(
    ...
    const extension = dataConfig.url.slice(
      dataConfig
        .url
        .length -
        3
  ...
  tile(
    ...
    return this.tilesetInfo().then(
      tsInfo => {
        ...
        const filtered = this.cdss.filter(
          v =>
            v.end >
              minX &&
            v.start <
        ...
        collapsedPlus.forEach(
          v => {
            v.strand =
              '+';
          }
        );
        collapsedMinus.forEach(
          v => {
            v.strand =
              '-';
          }
