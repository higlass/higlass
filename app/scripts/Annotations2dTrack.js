...
class Annotations2dTrack extends TiledPixiTrack {
  constructor(
    ...
    this.options.minSquareSize = +this
      .options
      .minSquareSize;
    ...
    this.annoSelectedBound = this.annoSelected.bind(
      this
    );
  ...
  _drawRect(
    ...
    let strokeAlpha = this
      .options
      .rectangleDomainStrokeOpacity;
    let fill = this
      .options
