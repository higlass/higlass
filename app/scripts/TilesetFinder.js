...
class TilesetFinder extends React.Component {
  constructor(
    ...
    const availableTilesetKeys = Object.keys(
      newOptions
    );
      ...
      ne => {
        const ane = Object.assign(
          ...
          ne,
          {
            ...
            tilesetUid:
              ne.uuid,
            serverUidKey: this.serverUidKey(
              sourceServer,
              ne.uuid
            ),
            datatype:
  ...
  requestTilesetLists() {
    ...
    if (
      ...
      console.warn(
        'No track source servers specified in the viewconf'
      );
      return;
    }

    this.props.trackSourceServers.forEach(
      sourceServer => {
        tileProxy.json(
            ...
            if (
              ...
              if (
                ...
                selectedUuid = availableTilesetKeys.length
                  ...
                  : null;
                const selectedTileset = this
                  .state
                  .options[
                  selectedUuid[0]
                ];
                this.props.selectedTilesetChanged(
                  [
                    selectedTileset
                  ]
                );
      ...
      >
        ...
        >
          <CheckboxTree
            ...
            onCheck={this.handleChecked.bind(
              this
            )}
            onExpand={this.handleExpanded.bind(
              this
            )}
          />
        </div>
