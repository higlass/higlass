...
import CenterTrack from '../ui-components/CenterTrack';
import DragListeningDiv from '../ui-components/DragListeningDiv';
import GalleryTracks from '../ui-components/GalleryTracks';
import TrackRendererPure from './TrackRendererPure';
...
import VerticalTiledPlot from '../ui-components/VerticalTiledPlot';
  ...
  */
  ...
  render() {
    ...
    if (this.state.sizeMeasured) {
      ...
      // }
      // else 
        this.trackRenderer = new TrackRendererPure({
