...
export const COLLAPSE = {
  id: 'collapse',
  paths: [
    "M22.6,15.4a1.9,1.9,0,0,0,2.8,0l6-5.9a2.1,2.1,0,0,0,.2-2.7,1.9,1.9,0,0,0-3-.2L26,9.2V4a2,2,0,0,0-4,0V9.2L19.4,6.6a1.9,1.9,0,0,0-3,.2,2.1,2.1,0,0,0,.2,2.7Z",
    "M25.4,32.6a1.9,1.9,0,0,0-2.8,0l-6,5.9a2.1,2.1,0,0,0-.2,2.7,1.9,1.9,0,0,0,3,.2L22,38.8V44a2,2,0,0,0,4,0V38.8l2.6,2.6a1.9,1.9,0,0,0,3-.2,2.1,2.1,0,0,0-.2-2.7Z",
    "M6,22H42a2,2,0,0,0,0-4H6a2,2,0,0,0,0,4Z",
    "M42,26H6a2,2,0,0,0,0,4H42a2,2,0,0,0,0-4Z"
  ],
  viewBox: '0 0 48 48',
};
...
export const EXPAND = {
  id: 'expand',
  paths: [
    "M28.6,17.4a1.9,1.9,0,0,0,3-.2,2.1,2.1,0,0,0-.2-2.7l-6-5.9a1.9,1.9,0,0,0-2.8,0l-6,5.9a2.1,2.1,0,0,0-.2,2.7,1.9,1.9,0,0,0,3,.2L22,14.8V33.2l-2.6-2.6a1.9,1.9,0,0,0-3,.2,2.1,2.1,0,0,0,.2,2.7l6,5.9a1.9,1.9,0,0,0,2.8,0l6-5.9a2.1,2.1,0,0,0,.2-2.7,1.9,1.9,0,0,0-3-.2L26,33.2V14.8Z",
    "M6,6H42a2,2,0,0,0,0-4H6A2,2,0,0,0,6,6Z",
    "M42,42H6a2,2,0,0,0,0,4H42a2,2,0,0,0,0-4Z"
  ],
  viewBox: '0 0 48 48',
};
