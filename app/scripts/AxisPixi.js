...
class AxisPixi {
  ...
  calculateAxisTickValues(
    ...
    let tickValues = valueScale.ticks(
      tickCount
    );
  ...
  exportAxisLeftSVG(
    ...
    const gAxis = this.exportVerticalAxis(
      axisHeight
    );
    ...
    for (
      ...
      if (
        ...
        const t = this.createAxisSVGText(
          text.text
        );
        g.appendChild(
          t
