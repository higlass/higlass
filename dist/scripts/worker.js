...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(370)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(375), __webpack_require__(376), __webpack_require__(369), __webpack_require__(377), __webpack_require__(378), __webpack_require__(379), __webpack_require__(370)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(378)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colormaps = __webpack_require__(586);

	var _d3Scale = __webpack_require__(374);

	var _d3Request = __webpack_require__(587);

	var _urlJoin = __webpack_require__(566);

	var _urlJoin2 = _interopRequireDefault(_urlJoin);

	var _d3Format = __webpack_require__(377);

	var _d3Array = __webpack_require__(375);
	...
	*/
	...
	function workerFetchTiles(tilesetServer, tileIds, done) {
	    var MAX_FETCH_TILES = 10;
	    var fetchPromises = [];
	    ...
	    var _loop = function _loop(i) {
	        ...
	        var outUrl = (0, _urlJoin2.default)(tilesetServer, 'tilesets/x/render/?' + renderParams);
	                ...
	                if (error) {
	                    ...
	                    for (var key in data) {
	                        ...
	                        if ('dense' in data[key]) {
	                            var newDense = _base64ToArrayBuffer(data[key].dense);
	    ...
	    Promise.all(fetchPromises).then(function (datas) {
	        ...
	        for (var _i = 1; _i < datas.length; _i++) {
	            for (var uid in datas[_i]) {
	                datas[0][uid] = datas[_i][uid];
	            }
	        }
	...
	function workerLoadTileData(tile_value, tile_type) {
	    ...
	    if (tile_type == 'dense') return tile_value;else if (tile_type == 'sparse') {
	        var values = [];
	        for (var _i3 = 0; _i3 < resolution * resolution; _i3++) {
	            values.push(0);
	        }var i = 0;
	...
	function workerSetPix(size, data, minVisibleValue, maxVisibleValue) {
	    var colorScale = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
	    var passedCountTransform = arguments[5];

	    var epsilon = 0.000001;
	    //console.log('minVisibleValue:', minVisibleValue);

	    var countTransform = function countTransform(x) {
	        return Math.log(x);
	    };

	    //let qScale = scaleQuantile().domain(data).range(range(255));
	    var valueScale = (0, _d3Scale.scaleLinear)().range([254, 0]).domain([countTransform(minVisibleValue), countTransform(maxVisibleValue)]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(376), __webpack_require__(220), __webpack_require__(588)) :
