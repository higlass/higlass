  ...
  describe('Axis texts', () => {
    ...
    it('Checks the label margin', () => {
      ...
      expect(track1.labelText.x).to.equal(
        track1.position[0] + track1.options.labelLeftMargin + track1.labelText.width / 2
      );
      expect(track1.labelText.y).to.equal(track1.position[1] + track1.options.labelTopMargin);
      ...
      expect(track2.labelText.y).to.equal(track2.position[1] + track2.options.labelTopMargin);

      // pos: bottomLeft margin: 0 0 10 10
      expect(track3.labelText.x).to.equal(
        track3.position[0] + track3.options.labelLeftMargin + track3.labelText.width / 2
      );
      expect(track3.labelText.y).to.equal(
        track3.position[1] + track3.dimensions[1] - track3.options.labelBottomMargin
      );
      ...
      expect(track4.labelText.y).to.equal(
        track4.position[1] + track4.dimensions[1] - track4.options.labelBottomMargin
      );
    });
