...
describe('Simple HiGlassComponent', () => {
  ...
  describe('Track positioning', () => {
    ...
    it('should add a large horizontal heatmap', (done) => {
      ...
      console.log('adding large horizontal track');
      expect(hgc.instance().state.views.aa.layout.h).to.eql(4);
    ...
    it('Should add a bottom track and have the new height', (done) => {
      expect(hgc.instance().tiledPlots.aa.trackRenderer.getTrackObject('heatmap3').dimensions[1]).to.be.above(100);
