...
vi.describe('Track types', () => {
  ...
  vi.it(
    'Ensures that only the gene-annotations and 1d-tiles tracks are listed',
    () => {
      const clickPosition = {
        bottom: 85,
        height: 28,
      ...
      vi.expect(trackTypeItems.props.menuItems['gene-annotations']).to.exist;
      vi.expect(trackTypeItems.props.menuItems['horizontal-1d-tiles']).to.exist;
