...
describe('Overlay Track:', () => {
  ...
  describe('Annotation overlays:', () => {
    it('Should render', () => {
      ...
      const overlayTrackInfo = trackRenderer.trackDefObjects[overlayTrack.track.uid];
  ...
  describe('Chromosome grid overlay:', () => {
    it('Should render', done => {
      ...
      const overlayTrackInfo = trackRenderer.trackDefObjects[viewConf.views[0].overlays[0].uid];
